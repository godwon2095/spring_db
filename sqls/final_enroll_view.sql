...
CREATE VIEW final_enroll_view AS
  select e.e_id e_id, e.s_id s_id, e.c_id c_id, e.c_id_no c_id_no, e.e_year v_year, e.e_semester v_semester,
         e.e_success v_success, p.p_id p_id, p.p_amount v_amount, p.p_type v_type, p.p_created_at v_created_at, t.t_id t_id, t.t_max v_max
